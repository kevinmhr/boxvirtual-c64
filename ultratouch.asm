...
SETUPSPRITES                           
                ...
                LDA #$02               ;--> RED
                STA $D026
                LDA #$0D                 ; COLORIZE SPRITES            
                STA $D027                ;-> SPRITE 0 (MAINSHIP) COLOR = LT.BLUE
                LDA #$0F                 ;-> SPRITE 1 (ENEMY) COLOR = WHITE      
                STA $D028
                LDA #$0B                 ;-> SPRITE 2 (BULLET) COLOR = WHITE
                STA $D029
                LDA #$08                 ;-> SPRITE 3 (ENEMY BULLET) COLOR = DARK GREY 
                STA $D02A
                LDA #$09                 ;-> SPRITE 4 (ENEMY2) COLOR = DARK GREY
                STA $D02B
                LDA #$06                 ;-> SPRITE 5 (EMENY 2 BULLET) COLOR = YELLOW
                STA $D02C
                LDA #$05                  ;-> SPRITE 6 (EXPLOSION) COLOR = MED.GREY 
                STA $D02D
                LDA #$0E                 ;-> SPRITE 7 (MISSILE) COLOR = ORANGE
                STA $D02E
                LDA #%11111111          ; SET MULTICOLOR BITS     
              ...
              ;  LDA #$84                ; ENEMY SHIP 2
               ...
               ; LDA $07F8               ; MISSILE
                STA $07FF
                LDA #%1111111         ; TURN ON 7 SPRITES - EXPLOSION NOT INCLUDED
                STA $D015
                RTS
cls
...
otherenemy
                      ...
                      LDY SPRITEPOS+$0C       ; COPY ENEMY SHIP COORDINATES
                STY SPRITEPOS+$06 
                  LDY SPRITEPOS+$0D       ; COPY ENEMY SHIP COORDINATES
                STY SPRITEPOS+$07 
                jsr afterotherenemy
                rts
 ;-------------------------ENEMYSHIP MOVEMENT-------------------------------------
...
COLLISIONCHECK
                ...
                BEQ COLLIDED5
                 CMP #%01000100       ; CHECK IF MAIN SHIP BULLET AND ENEMY SHIP COLLIDED
                BEQ COLLIDED
...
COLLIDED
             ...
             ;   inc SPRBUF 
                ...
                LDA #%11111111        ; RETURN BACK TO ORIGINAL POSITIONS EXCEPT MAIN SHIP
                inc bgchar
...
COLLIDED2
                ...
                LDA #%11111111        ; 7 SPRITES ARE ON (AGAIN)  
                STA $D015           
                LDA #$00              ; RESET COLLISION REGISTER
                STA $D01E      
...
changespritecol
                          ...
                          ;--> RED
                           ...
                           ; COLORIZE SPRITES            
                inc $D027                ;-> SPRITE 0 (MAINSHIP) COLOR = LT.BLUE
                       ;-> SPRITE 1 (ENEMY) COLOR = WHITE      
               inc $D028
                          ;-> SPRITE 2 (BULLET) COLOR = WHITE
               inc $D029
                          ;-> SPRITE 3 (ENEMY BULLET) COLOR = DARK GREY 
                inc $D02A
                          ;-> SPRITE 4 (ENEMY2) COLOR = DARK GREY
                inc $D02B
                            ;-> SPRITE 5 (EMENY 2 BULLET) COLOR = YELLOW
                inc $D02C
                              ;-> SPRITE 6 (EXPLOSION) COLOR = MED.GREY 
                inc $D02D
                                ;-> SPRITE 7 (MISSILE) COLOR = ORANGE
               inc $D02E
rts
